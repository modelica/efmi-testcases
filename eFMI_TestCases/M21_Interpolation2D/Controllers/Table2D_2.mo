...
block Table2D_2
  ...
  Utilities.CombiTable2D   table2(
    ...
    Modelica.Blocks.Nonlinear.Limiter limiter2(uMax=6)
  ...
  Utilities.CombiTable2D   table1(
    ...
    Modelica.Blocks.Nonlinear.Limiter limiter1(uMax=6.0)
    annotation (Placement(transformation(extent={{40,40},{60,60}})));
equation
  connect(table2.y, limiter2.u)
    annotation (Line(points={{11,-50},{36,-50}},
                                             color={0,0,127}));
  connect(limiter2.y, y[1])
    annotation (Line(points={{59,-50},{80,-50},{80,0},{108,0},{108,-2.5},{110,
          -2.5}},                                             color={0,0,127}));
  connect(table2.u2, u[2])
    annotation (Line(points={{-12,-56},{-90,-56},{-90,0},{-110,0},{-110,2},{
          -116,2},{-116,5},{-120,5}},                       color={0,0,127}));
  connect(table2.u1, u[1]) annotation (Line(points={{-12,-44},{-50,-44},{-50,0},
          {-112,0},{-112,-5},{-120,-5}},
                 color={0,0,127}));
  connect(u[2], table1.u1) annotation (Line(points={{-120,5},{-118,5},{-118,6},
          {-114,6},{-114,0},{-90,0},{-90,56},{-12,56}},
                    color={0,0,127}));
  connect(table1.y, limiter1.u)
    annotation (Line(points={{11,50},{38,50}}, color={0,0,127}));
  connect(limiter1.y, y[2])
    annotation (Line(points={{61,50},{80,50},{80,0},{108,0},{108,2.5},{110,2.5}},
                                                              color={0,0,127}));
  connect(table2.u1, table1.u2) annotation (Line(points={{-12,-44},{-50,-44},{
          -50,44},{-12,44}},
                         color={0,0,127}));
end Table2D_2;
