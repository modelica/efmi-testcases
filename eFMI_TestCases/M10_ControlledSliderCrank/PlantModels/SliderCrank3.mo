...
model SliderCrank3
  ...
  eFMI_TestCases.M10_ControlledSliderCrank.Utilities.JointSSR2 jointSSR(rod1Length=
        0.5, rRod2_ib={0.1,0,0}, positiveBranch=false) annotation (Placement(transformation(
        extent={{-20,-20},{20,20}},
        rotation=-90,
        origin={0,-38})));
...
equation
  ...
  connect(inertia1.flange_b, jointSSR.axis) annotation (Line(points={{-60,-90},
          {6,-90},{6,-68},{16,-68},{16,-58}}, color={0,0,0}));
