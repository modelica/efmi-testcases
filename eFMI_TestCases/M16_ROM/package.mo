...
<blockquote><br><img src=\"modelica://eFMI_TestCases/Resources/Images/M16_ROM/DAE_eq_system.png\" alt=\"E * der(x) = A * x + B* u\"/> </blockquote>
<p><i>E</i> and <i>A</i> are 22x22 matrices. <i>E</i> ist constant, <i>A</i> and <i>B</i> vary with time. </p>
<p>The model output equation</p>
<p style=\"margin-left: 30px;\"><img src=\"modelica://eFMI_TestCases/Resources/Images/M16_ROM/output_equation.png\" alt=\"y = C * x\"/></p>
