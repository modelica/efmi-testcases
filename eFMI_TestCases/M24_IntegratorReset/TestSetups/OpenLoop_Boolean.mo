...
model OpenLoop_Boolean
  ...
  Modelica_Synchronous.BooleanSignals.Sampler.Sample sample2
...
equation
  ...
  connect(sample1.y,integratorWithReset. u)
    annotation (Line(points={{-23.4,20},{0,20},{0,0},{18,0}},
                                                  color={0,0,127}));
  connect(integratorWithReset.y,hold1. u)
    annotation (Line(points={{41,0},{62.8,0}},   color={0,0,127}));
  connect(sample2.y,integratorWithReset. reset) annotation (Line(points={{-23.4,
          -20},{0,-20},{0,-8},{18,-8}},          color={255,0,255}));
  connect(greaterEqual.y,sample2. u)
    annotation (Line(points={{-59,-20},{-37.2,-20}}, color={255,0,255}));
  connect(sine2.y,greaterEqual. u1)
    annotation (Line(points={{-41,-80},{-92,-80},{-92,-20},{-82,-20}},
                                                   color={0,0,127}));
  connect(const.y,greaterEqual. u2) annotation (Line(points={{-41,-50},{-88,-50},
          {-88,-28},{-82,-28}}, color={0,0,127}));
  annotation (
