...
partial model maxHold_interface
  ...
  parameter Real holdDuration = 0.2 "Time to hold signal";
  parameter Real fallingRate = -10.0 "Falling rate";

  parameter Real uMin = -1000 "Minimum value of input that can occur";

  Modelica.Blocks.Interfaces.RealInput u(min=-1.0e7, max=1.0e7)
    annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
  Modelica.Blocks.Interfaces.RealOutput y
    annotation (Placement(transformation(extent={{100,-10},{120,10}})));

  annotation (Icon(graphics={
          Line(points={{-80,-100},{-80,70}},color={192,192,192}),Text(
            extent={{-71,92},{-44,72}},
            lineColor={0,0,0},
