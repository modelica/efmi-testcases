...
<p>
This package contains utility functions to export lists of test case names and used model classes. Further, it provides functions to automatically generate reference result files by Dymola scripting in csv format.
</p>
