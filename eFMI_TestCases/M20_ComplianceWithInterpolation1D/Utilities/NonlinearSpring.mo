...
equation
  ...
  connect(relSpeedSensor.w_rel, damping.u)
    annotation (Line(
      points={{-60,-71},{-60,-80},{-42,-80}},
      color={0,0,127}));
  connect(damping.y, add.u2)
    annotation (Line(
      points={{-19,-80},{0,-80},{0,-46},{17,-46}},
      color={0,0,127}));
  connect(add.y, torque.tau)
    annotation (Line(
      points={{40,-40},{46,-40},{46,-4}},
      color={0,0,127}));
  connect(table.y[1], add.u1)
    annotation (Line(
      points={{-19,-40},{-10,-40},{-10,-34},{17,-34}},
      color={0,0,127}));
  connect(flange_a, relAngleSensor.flange_a)
    annotation (Line(
      points={{-100,0},{-80,0},{-80,-20},{-70,-20}},
      color={0,0,0}));
  connect(relAngleSensor.flange_b, flange_b)
    annotation (Line(
      points={{-50,-20},{86,-20},{86,0},{100,0}},
      color={0,0,0}));
  connect(flange_a, relSpeedSensor.flange_a)
    annotation (Line(
      points={{-100,0},{-80,0},{-80,-60},{-70,-60}},
      color={0,0,0}));
  connect(relSpeedSensor.flange_b, flange_b)
    annotation (Line(
      points={{-50,-60},{86,-60},{86,0},{100,0}},
      color={0,0,0}));
  connect(relAngleSensor.phi_rel, table.u)
    annotation (Line(
      points={{-60,-31},{-60,-40},{-42,-40}},
      color={0,0,127}));
