...
model WheelWithLinearSlip
  ...
  parameter .Modelica.Units.SI.Radius wheelRadius;
  parameter SI.Inertia J
    "Wheel inertia";
  parameter SI.Force stiffness
    "Slip stiffness (fDrive = stiffness*slip)";
  ...
  Real slip
    "Longitudinal slip = (R*w - v)/R*abs(w)";
  SI.Force fDrive
    "Driving force of wheel";
  SI.AngularVelocity w
    "Angular velocity of wheel axis";
  SI.Velocity v
    "Velocity of wheel center";
  SI.Velocity v_roll
    "Rolling velocity of wheel";
  SI.Velocity v_slip
    "Slip velocity of wheel";
