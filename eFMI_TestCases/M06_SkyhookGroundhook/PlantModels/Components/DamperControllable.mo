...
model DamperControllable
  ...
  parameter Real dMax=200 "Upper limits of controllable damper coefficient";
  parameter Real dMin=100 "Lower limits of controllable damper coefficient";
...
equation
  f = limiter.y*v_rel;
  lossPower = f*v_rel;
  connect(limiter.u, d) annotation (Line(points={{-5.55112e-016,-77.6},{-5.55112e-016,
          -87.8},{0,-87.8},{0,-110}}, color={0,0,127}));
  annotation (
