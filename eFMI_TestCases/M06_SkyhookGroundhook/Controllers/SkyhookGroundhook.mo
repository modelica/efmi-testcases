...
model SkyhookGroundhook
  ...
  parameter Real gainSH = 4000
    "Gain of Skyhook controller";
  parameter Real gainGH = 10
    "Gain of Skyhook controller";
  parameter Real uDMax = 2000
    "Upper limits of damper control signals";
  parameter Real uDMin = 100
    "Lower limits of damper control signals";
  ...
  .Modelica.Blocks.Interfaces.RealInput v_body(
    min = -1e3,
    max = 1e3)
  ...
  .Modelica.Blocks.Interfaces.RealOutput u_damper(
    min = -1e5,
    max = 1e5) "Control signal of damper"
    annotation (Placement(
...
equation
  ...
  connect(skyhook.u_damper, add.u1)
    annotation (Line(
      points={{1,30},{10,30},{10,6},{20,6}},
      color={0,0,127}));
  connect(groundhook.u_damper, add.u2)
    annotation (Line(
      points={{1,-30},{10,-30},{10,-6},{20,-6}},
      color={0,0,127}));
  connect(v_body, skyhook.v_body)
    annotation (Line(
      points={{-120,60},{-68,60},{-68,36},{-22,36}},
      color={0,0,127}));
  connect(v_wheel, groundhook.v_wheel)
    annotation (Line(
      points={{-120,0},{-68,0},{-68,-24},{-22,-24}},
      color={0,0,127}));
  connect(v_damper, skyhook.v_damper)
    annotation (Line(
      points={{-120,-60},{-44,-60},{-44,24},{-22,24}},
      color={0,0,127}));
  connect(v_damper, groundhook.v_damper)
    annotation (Line(
      points={{-120,-60},{-44,-60},{-44,-36},{-22,-36}},
      color={0,0,127}));
