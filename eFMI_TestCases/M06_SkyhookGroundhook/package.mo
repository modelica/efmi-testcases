...
<p>
Test case of a Skyhookgroundhook control of a semi-active damper.
</p>

<h3>Main Author</h3>

<blockquote>
Ricardo de Castro and Michael Fleps-Dezasse (German Aerospace Center (DLR),
